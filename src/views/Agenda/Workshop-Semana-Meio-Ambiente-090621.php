        ...
        <div class="mapaSite">
            <div class="container">
                <ol class="breadcrumb mapaSite">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Workshop: Palestra dia Mundial do Meio Ambiente - CTG Brasil</li>
                </ol>
            </div>
        </div>
    </section>
...
-->
    <section>
        <div class="tituloPage">
            <div class="container">
                <label>Workshop: Palestra dia Mundial do Meio Ambiente - CTG Brasil</strong>
            </div>
        </div>
    </section>
...
-->
    <section>
        ...
        <div class="container">
            ...
            <p>
                Palestra dia Mundial do Meio Ambiente - CTG Brasil

            <p><b>Tema 1º Palestra:</b> Programa de Promoção Florestal da CTG Brasil<br>
                <b>Tema 2º Palestra:</b> Programa de Educação Ambiental da UHE Jurumirim
            </p>
            </p>

            <div class="data-evento">
                <p><span>Data:</span> 09 de JUnho de 2021 </p>
            ...
            <section>
                ...
                <div class="rom">
                    ...
                    <button style="margin-top: 30px;" type="submit" onclick="userWokshop03()">CONCLUIR</button>
                </div>

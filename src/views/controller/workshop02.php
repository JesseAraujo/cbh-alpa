...
$validacao = crypt($campo2, $campo2);
$validacao = strtoupper($validacao);

try {
    //insere no BD
    $sql = mysqli_query($con, "INSERT INTO cbhalpa_inscrito (cpf, nome, entidade, cidade, telefone, celular, email, validacao, curso_id) VALUES ('$campo2', '$campo1', '$campo3', '$campo4', '$campo5', '$campo6', '$campo7', '$validacao', '3')");

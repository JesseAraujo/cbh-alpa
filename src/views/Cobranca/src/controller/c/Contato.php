...
//1 – Definimos Para quem vai ser enviado o email
	$para = "cobranca.alpa@daee.sp.gov.br";
...
// 5 - resgatar o email digitado no formulário e  grava na variavel 
 ...
 //5 – Agora definimos a  mensagem que vai ser enviado no e-mail
	...
	$mensagem .= "<br>
					<img src='https://cbhalpa.com.br/Cobranca/src/controller/c/rodapeemail.png' style='margin-top: 20px; margin-bottom: 20px;'>"; //imagem assinatura
